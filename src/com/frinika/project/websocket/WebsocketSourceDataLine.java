...
import com.frinika.project.websocket.WebsocketDataLine.AudioFloatInputStreamResampler;
...
public final class WebsocketSourceDataLine extends WebsocketDataLine
  ...
  WebsocketSourceDataLine(WebsocketMixer mixer, DataLine.Info info) {
    super(mixer, info);
  }
