...
public final class WebsocketMixer implements Mixer {

  public void openLine(WebsocketSourceDataLine websocketSourceDataLine) {
  }
  ...
  private static class Info extends Mixer.Info {
    ...
    private WebsocketMainMixer mainmixer = null;

    private AudioFormat format = new AudioFormat(44100, 16, 2, true, false);

    private WebsocketSourceDataLine sourceDataLine = null;
...
//        if ((info.getLineClass() == SourceDataLine.class)) {
            return new WebsocketSourceDataLine(this, (DataLine.Info) info);
//        }
//
//        throw new IllegalArgumentException("Line unsupported: " + info);
    }
    ...
    public javax.sound.sampled.Line.Info[] getSourceLineInfo(
        ...
        int i;
        ArrayList<Line.Info> infos = new ArrayList<javax.sound.sampled.Line.Info>();
    ...
    public Line[] getSourceLines() {
        ...
        synchronized (control_mutex) {
          ...
          if (mainmixer == null) {
            ...
            WebsocketSourceDataLine[] sourceLines = mainmixer.getOpenLines();
...
//        return false;
  ...
  public javax.sound.sampled.Line.Info getLineInfo() {
    ...
    public void open(WebsocketSourceDataLine line) throws LineUnavailableException {
        if (isOpen()) {
            implicitOpen = false;
            return;
        }
...
//                double latency = this.latency;
      ...
      if (isOpen()) {
        ...
        synchronized (control_mutex) {
          ...
          if (targetFormat != null) {
            ...
            mainmixer = new WebsocketMainMixer(this);
    ...
    WebsocketMainMixer getMainMixer() {
      if (!isOpen()) {
        return null;
      }
        return mainmixer;
